"""
Simplified ETL Integration Tests

Basic tests for ETL components without heavy dependencies.
"""
...
# Import only the components we can test without TensorFlow
...
class TestETLExtractors:
    ...
    def test_csv_extractor(self, sample_csv_data):
        ...
        try:
            # Test extraction using async wrapper
            from app.etl.extractors import extract_async
            result = asyncio.run(extract_async(csv_path))
...
class TestETLTransformers:
    ...
    def test_transformer_pipeline(self, sample_raw_data):
        ...
        from app.etl.transformers import TextCleaner, FieldStandardizer
        
        # Create pipeline with default transformers
    ...
    def test_complete_etl_pipeline(self, complete_dataset):
        ...
        try:
            ...
            async def run_pipeline():
                # Extract using async wrapper
                from app.etl.extractors import extract_async
                raw_data = await extract_async(json_path)
